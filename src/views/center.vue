  ...
  <div id="center">
    <div class="up">
      ...
      >
        ...
        <div style="text-align: center;line-height: 2;color: #ffc107">
          {{this.result.sumCar}}
        </div>
      </div>
      <div
      ...
      >
        <p class="ml-3 colorBlue fw-b fs-xl">车辆最高销售额/辆</p>
        <div style="text-align: center;line-height: 2;color: #ffc107">
          {{this.result.hightVolume}}
        </div>
      </div>
      <div
        class="bg-color-black item"
      ...
      >
        <p class="ml-3 colorBlue fw-b fs-xl">车辆平均价格/万</p>
        <div style="text-align: center;line-height: 2;color: #ffc107">
          {{this.result.averagePrice}}
        </div>
      </div>
    </div>
    <div class="down">
      <div class="ranking bg-color-black">
        ...
        <span class="fs-xl text mx-2 mb-1 pl-3">车辆品牌榜</span>
...
export default {
  ...
  async mounted(){
    ...
    this.$set(this.water,'data',[res.data.otherRate])
  }
}
</script>
